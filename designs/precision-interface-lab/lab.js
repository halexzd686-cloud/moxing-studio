(() => {
  ...
  const specs = {
    c03: {
      ...
      background: `
        <path d="M 230 120 H 258 V 52 H 1126 V 96" pathLength="1" class="pi-evidence-route" />
        <path d="M 1126 96 V 108" pathLength="1" class="pi-evidence-route-accent" />`,
      foreground: `
        ...
        <text x="1105" y="143" text-anchor="end" font-size="10" class="pi-address pi-address-signal">LOCK / T12</text>`
    },
    c08: {
      code: "C08", name: "STAGE / CHANNEL", family: "STAGE", data: "05M · 04L", state: "BOTTLENECK",
      background: `
        <path d="M 230 146 H 260 V 448 H 798.8 V 270" pathLength="1" class="pi-evidence-route" />
        <path d="M 798.8 270 V 258" pathLength="1" class="pi-evidence-route-accent" />`,
      foreground: `
        ...
        <text x="798.8" y="279" text-anchor="middle" font-size="10" class="pi-address pi-address-signal">LOCK / Δ58</text>`
    },
    c15: {
      code: "C15", name: "COMMERCE / FLOW", family: "PORT", data: "05N · 04R", state: "LEAK.LOCK",
      background: `
        <path d="M 200 142 H 238 V 426 H 968.67 V 292" pathLength="1" class="pi-evidence-route" />
        <path d="M 968.67 292 V 282" pathLength="1" class="pi-evidence-route-accent" />`,
      foreground: `
        ...
        <text x="968.67" y="300" text-anchor="middle" font-size="10" class="pi-address pi-address-signal">PORT / L04</text>`
    },
    c22: {
      code: "C22", name: "ADDRESS / MATRIX", family: "MATRIX", data: "05×05", state: "PAIR.LOCK",
      background: `
        <path d="M 230 392 H 270 V 58 H 405 V 68" pathLength="1" class="pi-evidence-route" />
        <path d="M 405 68 V 76" pathLength="1" class="pi-evidence-route-accent" />`,
      foreground: `
        ...
        <text x="451" y="88" font-size="10" class="pi-address pi-address-signal">A02</text>`
    }
  };
  ...
  function instrument(frame) {
    ...
    window.setTimeout(() => frame.contentWindow.Moxing?.replay(), 120);
  }
  ...
  document.querySelector('[data-lab-action="replay"]').addEventListener("click", () => {
    const targets = state.view === "grid" ? frames : [frameByChart(state.active)];
    targets.forEach((frame) => frame?.contentWindow.Moxing?.replay());
  });
  ...
  new ResizeObserver(rescaleAll).observe(document.querySelector(".lab-workspace"));
  applyState();
})();
